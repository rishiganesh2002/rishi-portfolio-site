...
export function Avatar(props) {
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF("models/primaryModel.glb");
  ...
  fallingAnimation[0].name = "Standing";

  const { actions } = useAnimations(boxingAnimation, group);
...
useGLTF.preload("models/primaryModel.glb");
